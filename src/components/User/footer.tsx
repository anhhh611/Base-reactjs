          ...
          <div className="row">
            <div className="col-md-3 col-sm-6">
              <div className="footer-about-us">
                ...
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perferendis sunt id
            ...
            <div className="col-md-3 col-sm-6">
              <div className="footer-newsletter">
                ...
                <p>
                  Sign up to our newsletter and get exclusive deals you wont find anywhere else
          ...
          <div className="row">
            <div className="col-md-8">
              <div className="copyright">
                <p>
                  © 2015 uCommerce. All Rights Reserved.
                  <a href="https://freshdesignweb.com">freshDesignweb.com</a>
                </p>
              </div>
            </div>
